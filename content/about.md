...
My research interests lie mainly in the domain of deep learning and optimisation theory, computer vision and robotics especially works with strong theoritical foundations. I also find certain areas of high-performance computing quite fascinating.
<br><br>
...
<!-- 
### 🔬 Research Interests
* **Deep Learning Theory & Optimization:** Exploring architectural scaling laws and efficient training methodologies (e.g., Diffusion Models, Transformers).
* **Computer Vision:** Visual localization, object detection, and robust perception pipelines for autonomous systems.
* **Robotics & Control:** Bridging the gap between raw perception data and robust state estimation in real-world environments.

--- -->
<!-- 
### 🏆 Selected Achievements
* **Research Travel Grant:** Received funding to attend and present at ICC 2025.
* **Academic Excellence:** Maintained a strong academic standing in the Dept. of Electronics and Electrical Communication Engineering at IIT Kharagpur.
* *(Check my CV for a full list of hackathons, academic awards, and fellowships!)* -->
